...
import com.ncobase.framework.core.domain.model.XcxLoginBody;
import com.ncobase.framework.core.domain.model.XcxLoginUser;
...
public class XcxAuthStrategy implements IAuthStrategy {
    ...
    public LoginVo login(String body, SysClientVo client) {
        ...
        AuthRequest authRequest = new AuthWechatMiniProgramRequest(AuthConfig.builder()
            .clientId(appid).clientSecret("自行填写密钥 可根据不同 appid 填入不同密钥")
        ...
        if (resp.ok()) {
            ...
            // 微信小程序只有关联到微信开放平台下之后才能获取到 unionId，因此 unionId 不一定能返回。

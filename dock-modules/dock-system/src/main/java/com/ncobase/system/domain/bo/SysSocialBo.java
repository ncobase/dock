...
import com.ncobase.system.domain.SysSocial;
...
public class SysSocialBo extends TenantEntity {
     ...
     * 认证唯一 ID
     */
    @NotBlank(message = "认证唯一 ID 不能为空", groups = {AddGroup.class, EditGroup.class})
     ...
     * 用户的 ID
     */
    @NotBlank(message = "用户的 ID 不能为空", groups = {AddGroup.class, EditGroup.class})
    private Long userId;

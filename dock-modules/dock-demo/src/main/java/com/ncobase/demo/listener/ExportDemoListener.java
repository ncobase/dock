package com.ncobase.demo.listener;
...
import com.ncobase.framework.excel.core.DefaultExcelListener;
import com.ncobase.framework.excel.core.DropDownOptions;
    ...
    public void invoke(ExportDemoVo data, AnalysisContext context) {
        ...
        if (thisRowSelectedProvinceOption.size() == 2) {
            ...
            if (NumberUtil.isNumber(provinceIdStr)) {
                ...
                // 例如判断省信息是否在数据库中存在等，建议结合 RedisCache 做缓存 10s，减少数据库调用

...
import com.ncobase.workflow.common.enums.TaskAssigneeType;
import com.ncobase.workflow.common.enums.TaskStatusEnum;
...
import com.ncobase.workflow.handler.FlowProcessEventHandler;
import com.ncobase.workflow.handler.WorkflowPermissionHandler;
import com.ncobase.workflow.mapper.FlwCategoryMapper;
import com.ncobase.workflow.mapper.FlwTaskMapper;
import com.ncobase.workflow.service.IFlwTaskService;
import com.ncobase.workflow.utils.WorkflowUtils;
...
import static com.ncobase.workflow.common.constant.FlowConstant.*;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public StartProcessReturnDTO startWorkFlow(StartProcessBo startProcessBo) {
        ...
        if (StringUtils.isBlank(businessId)) {
            throw new ServiceException("启动工作流时必须包含业务 ID");
        }
        // 启动流程实例（提交申请）

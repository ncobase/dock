...
(
    ...
    description       nvarchar(256) NOT NULL DEFAULT '',
    token             nvarchar(64)  NOT NULL DEFAULT 'SJ_emjn4DNUm4riEcgZcRmLbynQ2QQquQiaZlMIsMty7Y',
...
EXEC sp_addextendedproperty
     'MS_Description', N'唯一 id 生成模式 默认号段模式',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_group_config',
...
VALUES (N'dev', N'dock_group', N'', N'SJ_emjn4DNUm4riEcgZcRmLbynQ2QQquQiaZlMIsMty7Y', N'1', N'1', N'0', N'1', N'1', N'4',
        getdate(), getdate())
GO
INSERT INTO sj_group_config(namespace_id, group_name, description, token, group_status, version, group_partition,
                            id_generator_mode, init_scene, bucket_index, create_dt, update_dt)
VALUES (N'prod', N'dock_group', N'', N'SJ_emjn4DNUm4riEcgZcRmLbynQ2QQquQiaZlMIsMty7Y', N'1', N'1', N'0', N'1', N'1', N'4',
        getdate(), getdate())
GO
...
EXEC sp_addextendedproperty
     'MS_Description', N'任务类型 1. 重试任务 2. 重试回调 3、JOB 任务 4、WORKFLOW 任务',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_notify_config',
...
EXEC sp_addextendedproperty
     'MS_Description', N'通知告警场景配置 id 列表',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_retry_scene_config',
     'COLUMN', N'notify_ids'
GO
...
VALUES (N'admin', N'465c194afb65670f38322df087f0a9bb225cc257e43eb4ac5a0c98ef5b3173ac', N'2', getdate(), getdate())
GO
...
EXEC sp_addextendedproperty
     'MS_Description', N'号段模式序号 ID 分配表',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_sequence_alloc'
GO
...
VALUES (N'dev', N'dock_group', N'demo-job', null, 1, 1710344035622, 1, 1, 4, 1, N'testJobExecutor', 2, N'60', 1, 60, 3,
        1, 1, 116, 0, N'', 1, N'', N'', 0, getdate(), getdate())
GO
...
EXEC sp_addextendedproperty
     'MS_Description', N'任务类型 3、JOB 任务 4、WORKFLOW 任务',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_job_task_batch',
     'COLUMN', N'system_task_type'
GO
...
EXEC sp_addextendedproperty
     'MS_Description', N'业务 id  ( job_id 或 workflow_id ) ',
     'SCHEMA', N'dbo',
     'TABLE', N'sj_job_summary',

...
values (1, '000000', '管理组', '13889815616', 'Dock Inc.', null, null, '数智化工作平台', null, null,
        null, null, -1, '0', '0', 103, 1, now(), null, null);
...
(
    dept_id
                  int8,
    tenant_id
                  varchar(20)  default '000000':: varchar,
...
values (100, '000000', 0, '0', 'XXX 科技', null, 0, null, '13889815616', 'xxx@qq.com', '0', '0', 103, 1, now(), null,
        null);
insert into sys_dept
values (101, '000000', 100, '0,100', '深圳总公司', null, 1, null, '13889815616', 'xxx@qq.com', '0', '0', 103, 1, now(),
        null, null);
insert into sys_dept
values (102, '000000', 100, '0,100', '长沙分公司', null, 2, null, '13889815616', 'xxx@qq.com', '0', '0', 103, 1, now(),
        null, null);
insert into sys_dept
values (103, '000000', 101, '0,100,101', '研发部门', null, 1, 1, '13889815616', 'xxx@qq.com', '0', '0', 103, 1, now(),
        null, null);
insert into sys_dept
...
comment
    on column sys_user.login_ip is '最后登陆 IP';
comment
...
values ('113', '缓存监控', '2', '5', 'cache', 'monitor/cache/index', '', '1', '0', 'C', '0', '0', 'monitor:cache:list',
        'redis', 103, 1, now(), null, null, '缓存监控菜单');
insert into sys_menu
values ('115', '代码生成', '3', '2', 'generator', 'tool/generator/index', '', '1', '0', 'C', '0', '0', 'tool:generator:list', 'code', 103,
...
-- springboot-admin 监控
insert into sys_menu
values ('117', '服务监控', '2', '5', 'Admin', 'monitor/admin/index', '', '1', '0', 'C', '0', '0',
        'monitor:admin:list', 'dashboard', 103, 1, now(), null, null, '服务监控菜单');
-- oss 菜单
insert into sys_menu
...
values ('120', '任务调度中心', '2', '6', 'snailjob', 'monitor/snailjob/index', '', '1', '0', 'C', '0', '0',
        'monitor:snailjob:list', 'job', 103, 1, now(), null, null, 'SnailJob 控制台菜单');
...
-- 代码生成按钮
insert into sys_menu
values ('1055', '生成查询', '115', '1', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:query', '#', 103, 1, now(),
        null, null, '');
insert into sys_menu
values ('1056', '生成修改', '115', '2', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:edit', '#', 103, 1, now(), null,
        null, '');
insert into sys_menu
values ('1057', '生成删除', '115', '3', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:remove', '#', 103, 1, now(),
        null, null, '');
insert into sys_menu
values ('1058', '导入代码', '115', '2', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:import', '#', 103, 1, now(),
        null, null, '');
insert into sys_menu
values ('1059', '预览代码', '115', '4', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:preview', '#', 103, 1, now(),
        null, null, '');
insert into sys_menu
values ('1060', '生成代码', '115', '5', '#', '', '', '1', '0', 'F', '0', '0', 'tool:generator:code', '#', 103, 1, now(), null,
        null, '');
-- oss 相关按钮
insert into sys_menu
...
insert into sys_config
values (11, '000000', 'OSS 预览列表资源开关', 'sys.oss.previewListResource', 'true', 'Y', 103, 1, now(), null, null,
        'true:开启，false:关闭');
...
comment
    on column sys_notice.notice_id is '公告 ID';
comment
...
(
    ...
    update_time       timestamp,
    remark            varchar(500)  default null :: varchar,
    constraint generator_table_pk primary key
        (
         table_id
            )
);
...
(
    ...
    table_id
                   int8,
    column_name
                   varchar(200) default null :: varchar,
    ...
    update_by      int8,
    update_time    timestamp,
    constraint generator_table_column_pk primary key
        (
         column_id
            )
);
...
insert into sys_oss_config
values (4, '000000', 'qcloud', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'dock-1240000000', '',
...
INSERT INTO test_demo
VALUES (2, '000000', 102, 3, 2, '子节点 1', '111', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (3, '000000', 102, 3, 3, '子节点 2', '222', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (4, '000000', 108, 4, 4, '测试数据', 'demo', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (5, '000000', 108, 3, 13, '子节点 11', '1111', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (6, '000000', 108, 3, 12, '子节点 22', '2222', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (7, '000000', 108, 3, 11, '子节点 33', '3333', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (8, '000000', 108, 3, 10, '子节点 44', '4444', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (9, '000000', 108, 3, 9, '子节点 55', '5555', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (10, '000000', 108, 3, 8, '子节点 66', '6666', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (11, '000000', 108, 3, 7, '子节点 77', '7777', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (12, '000000', 108, 3, 6, '子节点 88', '8888', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_demo
VALUES (13, '000000', 108, 3, 5, '子节点 99', '9999', 0, 103, now(), 1, NULL, NULL, 0);

INSERT INTO test_tree
VALUES (1, '000000', 0, 102, 4, '测试数据权限', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (2, '000000', 1, 102, 3, '子节点 1', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (3, '000000', 2, 102, 3, '子节点 2', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (4, '000000', 0, 108, 4, '测试树 1', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (5, '000000', 4, 108, 3, '子节点 11', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (6, '000000', 4, 108, 3, '子节点 22', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (7, '000000', 4, 108, 3, '子节点 33', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (8, '000000', 5, 108, 3, '子节点 44', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (9, '000000', 6, 108, 3, '子节点 55', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (10, '000000', 7, 108, 3, '子节点 66', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (11, '000000', 7, 108, 3, '子节点 77', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (12, '000000', 10, 108, 3, '子节点 88', 0, 103, now(), 1, NULL, NULL, 0);
INSERT INTO test_tree
VALUES (13, '000000', 10, 108, 3, '子节点 99', 0, 103, now(), 1, NULL, NULL, 0);

...
comment
    on column FLOW_NODE.DEFINITION_ID is '对应 flow_definition 表的 id';
comment
...
comment
    on column FLOW_SKIP.NOW_NODE_CODE is '当前流程节点类型 (0 开始节点 1 中间节点 2 结束节点 3 互斥网关 4 并行网关)';
comment
    on column FLOW_SKIP.NOW_NODE_TYPE is '下一个流程节点类型 (0 开始节点 1 中间节点 2 结束节点 3 互斥网关 4 并行网关)';
comment
    on column FLOW_SKIP.NEXT_NODE_CODE is '下一个流程节点编码';
comment
    on column FLOW_SKIP.NEXT_NODE_TYPE is '下一个流程节点类型 (0 开始节点 1 中间节点 2 结束节点 3 互斥网关 4 并行网关)';
comment
...
comment
    on column FLOW_INSTANCE.NODE_TYPE is '开始节点类型 (0 开始节点 1 中间节点 2 结束节点 3 互斥网关 4 并行网关)';
comment
...
comment
    on column FLOW_USER.CREATE_BY is '节点名称';
comment
...
VALUES (100, '000000', 0, '0', 'OA 审批', 0, '0', 103, 1, SYSDATE, NULL, NULL);
INSERT INTO flow_category

package com.ncobase.framework.redis.utils;
...
public class RedisUtils {
     ...
     * <p>
     * limit-设置扫描的限制数量 (默认为 0，查询全部)
     * pattern-设置键的匹配模式 (默认为 null)
     * chunkSize-设置每次扫描的块大小 (默认为 0，本方法设置为 1000)
     * type-设置键的类型 (默认为 null，查询全部类型)
     * </P>
     *
     * @param pattern 字符串前缀
     * @return 对象列表

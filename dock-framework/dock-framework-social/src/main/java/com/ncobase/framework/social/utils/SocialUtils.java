...
import com.ncobase.framework.social.maxkey.AuthMaxKeyRequest;
import com.ncobase.framework.social.topiam.AuthTopIamRequest;
...
public class SocialUtils {
    ...
    public static AuthRequest getAuthRequest(String source, SocialProperties socialProperties) throws AuthException {
        ...
        return switch (source.toLowerCase()) {
            ...
            // 支付宝在创建回调地址时，不允许使用 localhost 或者 127.0.0.1，所以这儿的回调地址使用的局域网内的 ip
            case "alipay_wallet" ->
